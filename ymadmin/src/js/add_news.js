(function(window, document){
	...
	// $('#js-news-date').datetimepicker('update');
	...
	function initEditor(){
		...
		$("#js-news-title").val(obj.title);
		$("#js-news-summary").val(obj.brief);
		$("#cover-image-thumb").data("src", obj.coverImg);
		$("#logo-image-thumb").data("src", obj.logoImg);
		$("#js-news-author").val(obj.uploader);
		$("#js-news-source").val(obj.source);
		$("#js-news-date").val(obj.date);
